...
➡️ [View related project on GitHub](https://github.com/kellyhuang-gis/xxx)
## Requirements  
...
**[NoiseModel.pkl](https://github.com/kellyhuang-gis/noise_model/tree/master)**   
the regression algorithms were applied to compute the estimated noise values   
    ```RF = joblib.load("NoiseModel.pkl")  # traffic noise value estimation```      
**result.xlsx**  
